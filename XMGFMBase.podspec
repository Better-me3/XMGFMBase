...
Pod::Spec.new do |s|
  s.name             = 'XMGFMBase'
  s.version          = '0.2.0'
  s.summary          = 'A short description of XMGFMBase.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Better-me3/XMGFMBase'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Better-me3' => 'zhang@aia.com' }
  s.source           = { :git => 'https://github.com/Better-me3/XMGFMBase.git', :tag => s.version.to_s }
